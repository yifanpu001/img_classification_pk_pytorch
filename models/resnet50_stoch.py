...
def createModel(depth=50, data='cifar10', num_classes=10, death_mode='none', death_rate=0.5,
                **kwargs):
    print('Create ResNet50_Stochastic_Depth-{:d} for {}'.format(depth, data))
    if depth == 50:
        return ResNet50_Stochastic_Depth(num_classes, pL=0.5)
    else:
        raise ValueError